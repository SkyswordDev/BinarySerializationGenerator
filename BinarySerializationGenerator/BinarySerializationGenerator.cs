...
namespace BinarySerializationGenerator
{
    ...
    public class BinarySerializationGenerator : ISourceGenerator
    {
        ...
        public static DiagnosticDescriptor IntegralLiteralExpressionOutOfRangeDescriptor { get; private set; }
        ...
        public void Initialize(GeneratorInitializationContext context)
        {
            ...
            IntegralLiteralExpressionOutOfRangeDescriptor = new DiagnosticDescriptor(
                id: "BS0005",
                title: "Integral value out of range.",
                messageFormat: @"Value {0} is out of range [{1}, {2}] for field type {3}.",
                category: descriptorCategory,
                defaultSeverity: DiagnosticSeverity.Error,
                isEnabledByDefault: true,
                description: @"Value {0} is out of range [{1}, {2}] for field type {3}.",
                helpLinkUri: null,
                customTags: descriptorTags
                );
